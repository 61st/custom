class CamoBase {
    ...
    // Frankly I don't know what SMB stands for. 
    class SMB {
        label = "SMB";
        image="#(rgb,8,8,3)color(0.34,0.33,0.28,1)";
    };
    // The "Woodland" camo found on SAF vests and headgear. 
    class WDL_SAF {
        label = "Serb WDL";
    ...
    // Semi-Arid camo for MICH and ACH. 
    class SA_MICH {
        label = "Semi-Arid";
