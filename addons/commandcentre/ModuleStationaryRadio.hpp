class LXIM_ModuleStationaryRadio: Module_F
{
    scope = 2;
    displayName = "Setup Stationary Radio";
    icon = "\z\lxim\addons\media\images\icons\StationaryRadio.paa"; //todo: proper icon
    category = QPREFIX;
    function = "lxim_commandcenter_fnc_moduleStationaryRadio";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        class StationaryRadioOn: Checkbox
          {
                property = "lxim_StationaryRadioOn";
        ...
        class StationaryRadioCh1: Edit
          {
                property = "lxim_StationaryRadioCh1";
        ...
        class StationaryRadioCh2: Edit
          {
                property = "lxim_StationaryRadioCh2";
        ...
        class StationaryRadioVol: Edit
          {
                property = "lxim_StationaryRadioVol";
        ...
        class StationaryRadioClass: Edit
          {
                property = "lxim_StationaryRadioClass";
        ...
        class StationaryRadioCode: Edit
          {
                property = "lxim_StationaryRadioCode";
