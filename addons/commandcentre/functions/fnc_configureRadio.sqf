...
// set up uiNamespace
uiNamespace setVariable ["SIXTYONE_CC_currentRadioObject", _radio];
...
_buttonOK ctrlSetEventHandler ["ButtonClick", format["[] call sixtyone_commandcenter_fnc_handleRadioConfig"]];
