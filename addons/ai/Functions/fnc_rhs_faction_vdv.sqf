...
_infaaList    = ["rhs_group_rus_vdv_infantry_section_AA"];
_infatList    = ["rhs_group_rus_vdv_infantry_section_AT"];
_sniperList   = ["rhs_group_rus_vdv_infantry_section_marksman","rhs_group_rus_vdv_infantry_squad_sniper"];
