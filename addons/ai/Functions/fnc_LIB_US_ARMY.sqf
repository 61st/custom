...
_infaaList    = [];
_infatList    = ["LIB_US_AT_Squad"];
_sniperList   = ["LIB_US_Sniper_Team"];
_vehAAList    = [];
_vehMrapList  = ["LIB_US_M3_Halftrack"];
_vehLightList = ["LIB_US_GMC_Tent","LIB_US_Scout_M3","LIB_US_Scout_M3_FFV","LIB_US_Willys_MB"];
