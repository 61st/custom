...
private _vehLightList = ["CFP_B_USSEALS_ATV_DES_01","CFP_B_USSEALS_HMMWV_SOV_M2_DES_01","CFP_B_USSEALS_HMMWV_SOV_Mk19_DES_01","CFP_B_USSEALS_Polaris_Dagor_DES_01"];
