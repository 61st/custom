class CfgUnitInsignia {
    class gbpmed {
        ...
        texture = "z\sixtyone\addons\media\images\patches\pmed.paa";   // Image path
        textureVehicle = "";             // Does nothing, reserved for future use
    };
    class gbpeod {
        displayName = "EOD";        // Name displayed in Arsenal
        author = QAUTHOR;              // Author displayed in Arsenal
        texture = "z\sixtyone\addons\media\images\patches\peod.paa";   // Image path
        textureVehicle = "";             // Does nothing, reserved for future use
    };
    class gbpjfire {
        displayName = "JFIRE";        // Name displayed in Arsenal
        author = QAUTHOR;              // Author displayed in Arsenal
        texture = "z\sixtyone\addons\media\images\patches\pjfire.paa";   // Image path
        textureVehicle = "";             // Does nothing, reserved for future use
    };
};