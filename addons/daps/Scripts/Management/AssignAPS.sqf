...
dapsVitebsk=dapsVitebsk-[_vehicleType];
dapsNemesis=dapsNemesis-[_vehicleType];
...
if(_APS=="Vitebsk")then{dapsVitebsk pushBack _vehicleType};
if(_APS=="Nemesis")then{dapsNemesis pushBack _vehicleType};
}forEach _units;
sleep 2;
