...
if(_type in dapsVitebsk)exitWith{_vehicle spawn DAPS_fnc_Vitebsk};
if(_type in dapsNemesis)exitWith{_vehicle spawn DAPS_fnc_Nemesis};
//dapsNoAPS pushBackUnique _vehicle;
