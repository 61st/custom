private["_v","_i","_b","_p","_d","_ex","_a","_rd","_s","_id","_sh"];
_v=_this select 0;
_i=_this select 1;
_sh=_this select 2;
...
//if(_sh)exitWith{deleteVehicle _i;[_v,_rd,_p,_id]call DAPS_fnc_TrophyHVe2};
if(_sh)exitWith{
    if(_rd>180)then{_a=_v getVariable"dapsAmmoL"}else{_a=_v getVariable"dapsAmmoR"};
    if(_a>0)then{deleteVehicle _i};
    [_v,_rd,_p,_id]call DAPS_fnc_TrophyHVe2;
};
if(_rd>180)then{_a=_v getVariable"dapsAmmoL"}else{_a=_v getVariable"dapsAmmoR"};
if(_a<1)exitWith{};
_ex=TRUE;
