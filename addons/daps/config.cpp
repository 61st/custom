...
{
    dapsInit="execVM'\daps\Scripts\Start.sqf'";
};

#include "\daps\Menu\zCoreDefines.hpp"
#include "\daps\Menu\Dialog.hpp"
            ...
            class dapsMaxAngle
              {
                ...
                description="Maximum angle at which incoming projectiles can be intercepted (-1 to disable)";
                typeName="NUMBER";
                defaultValue="45";
            };
            class dapsRearmRange
              {
                displayName="Rearm range";
                description="Range from supply vehicles at which APS will rearm";
                typeName="NUMBER";
                defaultValue="50";
            };
            class dapsRearmTime
              {
                ...
                description="Seconds to complete APS rearm";
                typeName="NUMBER";
                defaultValue="5";
            };
            class dapsRearmDelay
              {
                displayName="Rearm delay";
                description="Seconds between APS rearm checks";
                typeName="NUMBER";
                defaultValue="5";
            };
