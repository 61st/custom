...
["ace_medical_FatalInjury", {
    ...
    [{
        ...
        private _lastUpdate = _unit getVariable ["sixtyone_medical_cardiacArrestLastUpdate", -1];
        ...
        if (_timeLeft > 0 && {_lastUpdate + 1 < CBA_missionTime}) then {
            ...
            _unit setVariable ["sixtyone_medical_cardiacArrestLastUpdate", CBA_missionTime];
