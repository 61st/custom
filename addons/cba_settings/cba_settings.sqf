// 61st - ai
force lxim_AI_AimingAccuracy = 0.1;
force lxim_AI_AimingShake = 0.45;
force lxim_AI_AimingSpeed = 0.3;
force lxim_AI_CivCourage = 1;
force lxim_AI_CivFleeing = false;
force lxim_AI_Commanding = 1;
force lxim_AI_Courage = 1;
force lxim_AI_DynSim = true;
force lxim_AI_General = 1;
force lxim_AI_InitialAI = true;
force lxim_AI_ReloadSpeed = 0.5;
force lxim_AI_Reporting = false;
force lxim_AI_SpotDistance = 0.4;
force lxim_AI_SpotTime = 0.2;
force lxim_Zeus_Module_AISpawnsEast = true;
force lxim_Zeus_Module_AISpawnsIndep = true;
force lxim_Zeus_Module_AISpawnsWest = true;
force lxim_Zeus_Module_CivilianSpawns = true;

// 61st - ai_disembark
force lxim_ai_disembark_enabled = false;
force lxim_ai_disembark_stayInImmobileChance = 0;

// 61st - back_to_game
force lxim_back_to_game_enableAddon = true;
force lxim_back_to_game_removeBody = true;
force lxim_back_to_game_teleportToLeader = true;
force lxim_back_to_game_teleportToVehicle = true;

// 61ST - BFT
force lxim_bft_bftEnabled = true;
force lxim_bft_friendlySides_civilian = [0,2];
force lxim_bft_friendlySides_east = [3];
force lxim_bft_friendlySides_resistance = [1,3];
force lxim_bft_friendlySides_west = [2];
force lxim_bft_friendlySidesDynamic = true;
lxim_bft_groupIconsInteraction = "hover";
force lxim_bft_medicalSystem = "BIS";
force lxim_bft_requireItemGPS = true;
force lxim_bft_showAIGroups = true;
lxim_bft_showAINames = true;
force lxim_bft_showCivilians = false;
force lxim_bft_showGroupIcons = true;
lxim_bft_showGroupText = true;
force lxim_bft_showLifeState = true;
force lxim_bft_showOwnFactionOnly = false;
lxim_bft_showOwnGroup = true;
lxim_bft_showOwnGroupUnits = true;
lxim_bft_showplayerNames = true;
lxim_bft_showUnitNames = true;
lxim_bft_teamColors = "Default";
force lxim_bft_updateInterval = 0;

// 61st - common
lxim_common_showNotifcations = true;

// 61st - friendly_fire
force lxim_friendly_fire_loggingEnabled = false;

// 61st - grass
force lxim_grass_enabled = false;

// 61st - insurgents
force lxim_insurgents_enabled_CUP = true;
force lxim_insurgents_enabled_Vanilla = true;

// 61st - nvg
lxim_nvg_ACE = false;
lxim_nvg_Blacklist = "";
lxim_nvg_Effect = "wpEffect";

// 61st - remotesensors
force lximc_remotesensors_enabled = true;

// 61st - respawn
force lxim_respawn_enabled = false;
force lxim_respawn_time = 120;

// 61st - Suppress
force lxim_suppress_checkLOS = false;
force lxim_suppress_overlayFadeoutTime = 10;
force lxim_suppress_overlayOpacity = 0.96;
force lxim_suppress_overlayTexture = 1;
force lxim_suppress_projectileMaxDistance = 9;
force lxim_suppress_shooterMinDistance = 0;

// 61st - tagging
force lxim_tagging_enabled = false;
...
force force ace_common_swayFactor = 0.1;
...
// ACE G-Forces
force force ace_gforces_coef = 0.8;
...
force force ace_refuel_hoseLength = 40;
...
force force ace_magazinerepack_timePerAmmo = 0.5;
...
force force ace_markers_quickNumberMarks = 2;
...
force force ace_medical_gui_bloodLossColor_1 = [1,0.94,0.48,1];
force force ace_medical_gui_bloodLossColor_2 = [1,0.87,0.25,1];
force force ace_medical_gui_bloodLossColor_3 = [1,0.79,0.17,1];
force force ace_medical_gui_bloodLossColor_4 = [1,0.71,0.11,1];
force force ace_medical_gui_bloodLossColor_5 = [1,0.62,0.05,1];
force force ace_medical_gui_bloodLossColor_6 = [1,0.53,0.01,1];
force force ace_medical_gui_bloodLossColor_7 = [1,0.42,0,1];
force force ace_medical_gui_bloodLossColor_8 = [1,0.29,0,1];
...
force force ace_medical_gui_damageColor_1 = [0.52,0.73,1,1];
force force ace_medical_gui_damageColor_2 = [0.38,0.68,1,1];
force force ace_medical_gui_damageColor_3 = [0.37,0.6,1,1];
force force ace_medical_gui_damageColor_4 = [0.35,0.53,1,1];
force force ace_medical_gui_damageColor_5 = [0.33,0.45,1,1];
force force ace_medical_gui_damageColor_6 = [0.3,0.37,1,1];
force force ace_medical_gui_damageColor_7 = [0.25,0.29,1,1];
force force ace_medical_gui_damageColor_8 = [0.18,0.18,1,1];
...
force force ace_medical_treatment_convertItems = 1;
...
force force ACM_airway_treatmentTimeRecoveryPosition = 8;
force force ACM_airway_treatmentTimeSGA = 7;

// ACM: Breathing
force force ACM_breathing_allowInspectChest = 0;
force force ACM_breathing_allowNCD = 2;
force force ACM_breathing_allowThoracostomy = 2;
force force ACM_breathing_altitudeAffectOxygen = false;
force force ACM_breathing_chestInjuryChance = 1;
...
force force ACM_circulation_cardiacArrestBleedRate = 0.05;
force force ACM_circulation_cardiacArrestChance = 0.3;
force force ACM_circulation_cardiacArrestDeteriorationRate = 1;
...
force force ACM_circulation_selfIV = 0;
force force ACM_circulation_treatmentTimeIO_EZ = 4;
force force ACM_circulation_treatmentTimeIO_FAST1 = 4;
force force ACM_circulation_treatmentTimeIV_14 = 8;
force force ACM_circulation_treatmentTimeIV_16 = 6;
...
force force ACM_core_wrappedWoundReopenChance = 1;

// ACM: Damage
force force ACM_damage_AIStayDownChance = 1;
force force ACM_damage_bodyTraumaCardiacArrestThreshold = 0;
force force ACM_damage_bodyTraumaCardiacArrestThresholdAI = 16;
force force ACM_damage_bodyTraumaDeathThreshold = 0;
force force ACM_damage_bodyTraumaDeathThresholdAI = 24;
force force ACM_damage_enable = true;
force force ACM_damage_headTraumaCardiacArrestThreshold = 0;
...
force force ACM_evacuation_convertedCasualtyDeathPenalty = 0;
...
// ACM: GUI
force force ACM_gui_overlayBodyPart = false;
...
force force ACM_gui_showPatientSideLabels = false;
...
AIMEE_inventory_settingAssembleUavAction = true;
AIMEE_inventory_settingBackpackAction = true;
AIMEE_inventory_settingExplosivesAction = true;
...
// AIMEE - Terminals
AIMEE_uav_terminal_remoteControlAction = true;
...
AIMEE_vehicle_seats_settingForceEject = true;
...
// Better CAS Environment (ScreenShot)
...
force force BCE_cTab_Marker_Sync = "_USER";
force force BCE_cTab_Marker_Sync_time = 1;
force force BCE_cTab_Side_Display = true;
...
diwako_dui_nametags_fontCustomInfoSize = 7;
diwako_dui_nametags_fontGroup = "RobotoCondensedLight";
diwako_dui_nametags_fontGroupNameSize = 10.0508;
diwako_dui_nametags_fontName = "RobotoCondensedBold";
diwako_dui_nametags_fontNameSize = 7.03769;
...
hct_interaction_cursorColor = [0.95,0.95,0.95,1];
hct_interaction_cursorText = "Ã—";
...
// No Actions
no_actions_main_Assemble = false;
no_actions_main_AutoHover = false;
no_actions_main_AutoHoverCancel = false;
no_actions_main_BackFromUAV = false;
no_actions_main_CancelLand = false;
no_actions_main_CollisionLightOff = false;
no_actions_main_CollisionLightOn = false;
no_actions_main_DisAssemble = false;
no_actions_main_EngineOff = false;
no_actions_main_EngineOn = false;
no_actions_main_FlapsDown = false;
no_actions_main_FlapsUp = false;
no_actions_main_Gear = false;
no_actions_main_GetInCargo = false;
no_actions_main_GetInCommander = false;
no_actions_main_GetInDriver = false;
no_actions_main_GetInGunner = false;
no_actions_main_GetInPilot = false;
no_actions_main_GetInTurret = false;
no_actions_main_GetOut = false;
no_actions_main_Land = false;
no_actions_main_LandGear = false;
no_actions_main_LandGearUp = false;
no_actions_main_LightOff = false;
no_actions_main_LightOn = false;
no_actions_main_LoadEmptyMagazine = false;
no_actions_main_LoadOtherMagazine = false;
no_actions_main_LockVehicleControl = false;
no_actions_main_ManualFire = false;
no_actions_main_ManualFireCancel = false;
no_actions_main_MoveToCargo = false;
no_actions_main_MoveToCommander = false;
no_actions_main_MoveToDriver = false;
no_actions_main_MoveToGunner = false;
no_actions_main_MoveToPilot = false;
no_actions_main_MoveToTurret = false;
no_actions_main_PutBag = false;
no_actions_main_Refuel = false;
no_actions_main_Repair = false;
no_actions_main_RepairVehicle = false;
no_actions_main_SearchLightOff = false;
no_actions_main_SearchLightOn = false;
no_actions_main_SetTimer = false;
no_actions_main_SuspendVehicleControl = false;
no_actions_main_SwitchToUAVDriver = false;
no_actions_main_SwitchToUAVGunner = false;
no_actions_main_TakeDropWeapon = false;
no_actions_main_TakeItem = false;
no_actions_main_TakeVehicleControl = false;
no_actions_main_TakeWeapon = false;
no_actions_main_TouchOff = false;
no_actions_main_TouchOffMines = false;
no_actions_main_TurnIn = false;
no_actions_main_TurnOut = false;
no_actions_main_UAVTerminalMakeConnection = false;
no_actions_main_UAVTerminalOpen = false;
no_actions_main_UAVTerminalReleaseConnection = false;
no_actions_main_UnlockVehicleControl = false;
no_actions_main_UseMagazine = false;
no_actions_main_UseWeapon = false;
no_actions_main_VectoringDown = false;
no_actions_main_VectoringUp = false;
no_actions_main_VTOLVectoring = false;
no_actions_main_VTOLVectoringCancel = false;
...
force force TFAR_setting_defaultFrequencies_lr_west = "60,30,33,55,40,41,42,43";
...
tsp_cba_melee_black = "[]";
force force tsp_cba_melee_damage = 1;
...
// TUN Firesupport
Tun_firesupport_alwaysShowTRPmarkers = true;
force Tun_firesupport_debug = false;
Tun_firesupport_enableFiringPosMarker = true;
Tun_firesupport_enableShowTRPmarkers = true;
force Tun_firesupport_is_required = true;
Tun_firesupport_trpMarkerType = "mil_destroy_noShadow";
...
vtx_uh60_flir_setting_useScriptedCamera = true;
...
zen_faction_filter_0_DSF_HEZB = true;
...
zen_faction_filter_0_rhs_faction_rfgf = true;
...
zen_faction_filter_1_lxim = true;
