...
private _ctrlEditPos = [0.1 * SIXTYONE_ADMINMENU_STD_WIDTH, 0.1 * SIXTYONE_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth - (0.2 * SIXTYONE_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - (1.3 * SIXTYONE_ADMINMENU_STD_HEIGHT)];
...
_ctrlCombo ctrlSetPosition [0.1 * SIXTYONE_ADMINMENU_STD_WIDTH, _ctrlGrpHeight - SIXTYONE_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth * 0.3, SIXTYONE_ADMINMENU_STD_HEIGHT];
...
_ctrlButtonPreview ctrlSetPosition [(_ctrlGrpWidth * 0.7) - (0.2 * SIXTYONE_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - SIXTYONE_ADMINMENU_STD_HEIGHT, (_ctrlGrpWidth * 0.15), SIXTYONE_ADMINMENU_STD_HEIGHT];
...
_ctrlButtonCommit ctrlSetPosition [(_ctrlGrpWidth * 0.85), _ctrlGrpHeight - SIXTYONE_ADMINMENU_STD_HEIGHT, (_ctrlGrpWidth * 0.15) - (0.1 * SIXTYONE_ADMINMENU_STD_WIDTH), SIXTYONE_ADMINMENU_STD_HEIGHT];
