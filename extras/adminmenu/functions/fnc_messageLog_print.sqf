...
/* ----------------------------------------------------------------------------
Internal Function: SIXTYONE_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call SIXTYONE_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_SIXTYONE_ADMINMENU_MSGS_LIST;
