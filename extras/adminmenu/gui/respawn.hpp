class Controls
{
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_SPECTATORTEXT;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_SPECTATORLIST;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_ROLECOMBO;
        text = "Role";
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_RANK;
    ...
    // {
    //     idc = IDC_LXIM_ADMINMENU_RESP_SPECTATORVOIP;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_GROUPLIST;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_GROUPNAME;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_FACTIONCATEGORY;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_FACTION;
        text = "Faction";
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_SIDE;
        text = "Side";
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_GROUPMARKERNAME;
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_MARKERTYPE;
        text = "Side";
    ...
    {
        idc = IDC_LXIM_ADMINMENU_RESP_MARKERCOLOUR;
        text = "Side";
