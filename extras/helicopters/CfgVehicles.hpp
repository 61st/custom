...
class CfgVehicles {
    ...
    class GVAR(B_Heli_Transport_01_F_medic): B_Heli_Transport_01_F {
        ...
        displayName="LXIMHawk(MedEvac)"; /// how is the heli displayed in editor
        vehicleClass = "Air";
        faction = QUOTE(PREFIX);
        crew="B_Helipilot_F";
        typicalCargo[]= {
    ...
    class GVAR(B_Heli_Transport_01_F_sand): B_Heli_Transport_01_F {
        author = QAUTHOR;
        _generalMacro="B_Heli_Transport_01_F";
        displayName="LXIMHawk(Sand)"; /// how is the heli displayed in editor
        vehicleClass = "Air";
        faction = QUOTE(PREFIX);
        crew="B_Helipilot_F";
        typicalCargo[]= {
    ...
    class GVAR(B_Heli_Transport_01_F_trop): B_Heli_Transport_01_F {
        author = QAUTHOR;
        _generalMacro="B_Heli_Transport_01_F";
        displayName="LXIMHawk(Tropical)"; /// how is the heli displayed in editor
        vehicleClass = "Air";
        faction = QUOTE(PREFIX);
        crew="B_Helipilot_F";
        typicalCargo[]= {
    ...
    class GVAR(B_Heli_Transport_01_F_grey): B_Heli_Transport_01_F {
        author = QAUTHOR;
        _generalMacro="B_Heli_Transport_01_F";
        displayName="LXIMHawk(Grey)"; /// how is the heli displayed in editor
        vehicleClass = "Air";
        faction = QUOTE(PREFIX);
        crew="B_Helipilot_F";
        typicalCargo[]= {
