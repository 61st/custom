class CfgMarkers {
    ...
    class iconseng2 {
        name = "Zeus";
        icon = "z\lxim\addons\media\images\Icons\eng2.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
    ...
    class iconsjtac {
        name = "Zeus";
        icon = "z\lxim\addons\media\images\Icons\jtac.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
    ...
    class iconsmed2 {
        name = "Zeus";
        icon = "z\lxim\addons\media\images\Icons\med2.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
    ...
    class iconStaticAA {
        name = "Static AA";
        icon = "\A3\ui_f\data\map\vehicleicons\iconstaticaa_ca.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
    };
    class iconStaticCannon {
        name = "Static Cannon";
    ...
    class iconStaticMGNest {
        name = "Static MG Nest";
        icon = "\A3\ui_f\data\map\vehicleicons\iconstaticmgnest_ca.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
    };
    class iconStaticMortar {
        name = "Static Mortar";
    ...
    class iconStaticSearchlight {
        name = "Static Searchlight";
        icon = "\A3\ui_f\data\map\vehicleicons\iconstaticsearchlight_ca.paa";
        size = 24;
        shadow = "true";
        scope = 0;
        color[] = {1, 1, 1, 1};
