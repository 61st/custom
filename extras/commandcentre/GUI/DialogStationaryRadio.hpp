class RadioConfigDialog {
    ...
    class controls {
        ...
        class ChOneText: LXIM_CC_RscText
        {
            idc = 1002;
        ...
        class ChTwoText: LXIM_CC_RscText
        {
            idc = 1003;
        ...
        class ButtonOK: LXIM_CC_RscButton
        {
            idc = 1100;
            x = "10 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
        ...
        class ChOneEdit: LXIM_CC_RscEdit
        {
            idc = 1400;
            text = "30";
        ...
        class ChTwoEdit: LXIM_CC_RscEdit
        {
            idc = 1401;
            text = "40";
            x = "26 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X";
