class LXIM_ModuleMultiScreen: Module_F
{
    scope = 2;
    displayName = "Setup Multi Screen";
    icon = "\z\lxim\addons\media\images\icons\MultiScreen.paa";
    category = QPREFIX;
    function = "lxim_commandcenter_fnc_moduleMultiScreen";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        ...
        class MultiScreenDrone: Checkbox
          {
                property = "lxim_MultiScreenDrone";
        ...
        class MultiScreenSelections: Edit
          {
                property = "lxim_MultiScreenSelections";
