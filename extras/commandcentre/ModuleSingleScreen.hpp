class LXIM_ModuleSingleScreen: Module_F
{
    scope = 2;
    displayName = "Setup Single Screen";
    icon = "\z\lxim\addons\media\images\icons\SingleScreen.paa";
    category = QPREFIX;
    function = "lxim_commandcenter_fnc_moduleSingleScreen";
    functionPriority = 4;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase
    {
        ...
        class SingleScreenDrone: Checkbox
          {
                property = "lxim_SingleScreenDrone";
        ...
        class SingleScreenSelection: Edit
          {
                property = "lxim_SingleScreenSelection";
