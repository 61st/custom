...
// set up uiNamespace
uiNamespace setVariable ["LXIM_CC_currentRadioObject", _radio];
...
_buttonOK ctrlSetEventHandler ["ButtonClick", format["[] call lxim_commandcenter_fnc_handleRadioConfig"]];
