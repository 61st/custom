 ...
 *
 * Example:
 * [player, cursorObject] call sixtyone_defib_fnc_AEDStationCondition
 *
 * Public: No
 */
...
{
    if (typeOf _x isEqualTo "sixtyone_defib_AEDItem" || typeOf _x isEqualTo "Land_Defibrillator_F") then {
