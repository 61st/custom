...
force lxim_channels_CommandText = true;
force lxim_channels_CommandVoice = false;
force lxim_channels_DirectDuration = 0;
force lxim_channels_DirectText = true;
force lxim_channels_DirectVoice = false;
force lxim_channels_GlobalDuration = 300;
force lxim_channels_GlobalText = true;
force lxim_channels_GlobalVoice = false;
force lxim_channels_GroupDuration = 300;
force lxim_channels_GroupText = true;
force lxim_channels_GroupVoice = false;
force lxim_channels_SideDuration = 300;
force lxim_channels_SideText = true;
force lxim_channels_SideVoice = false;
force lxim_channels_VehicleDuration = 300;
force lxim_channels_VehicleText = true;
